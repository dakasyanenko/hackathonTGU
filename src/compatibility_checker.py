...
class CompatibilityChecker:
    ...
    def _extract_skills_from_text(text: str) -> set[str]:
        ...
        Фильтрует стоп-слова и HR/юридический boilerplate.
        """
        # Стоп-слова для фильтрации навыков
        _SKILL_STOPS = {
            "and", "for", "the", "with", "will", "are", "not", "but", "you",
            "all", "can", "has", "have", "had", "been", "was", "were", "that",
            "this", "from", "they", "she", "his", "its", "our", "their", "what",
            "when", "where", "which", "who", "how", "more", "must", "need",
            "may", "should", "would", "could", "also", "any", "than", "then",
            "into", "just", "some", "such", "only", "very", "well", "back",
            "even", "still", "yet", "after", "before", "being", "doing",
            "other", "about", "over", "through", "during", "without", "within",
            "along", "following", "across", "between", "both", "each",
            "few", "most", "own", "same", "so", "up", "out", "down", "here",
            "there", "too", "much", "many", "new", "old", "first", "last",
            "long", "great", "little", "right", "high", "different", "small",
            "large", "next", "early", "young", "important", "public", "bad",
            "good", "able", "like", "work", "way", "make", "know", "take",
            "come", "get", "see", "use", "find", "give", "tell", "go",
            "please", "upon", "want", "need", "looking", "experience",
            "required", "minimum", "skills", "position", "positions",
            "responsibilities", "qualifications", "requirements",
            # HR/legal boilerplate
            "equal", "opportunity", "employer", "employment", "company",
            "organization", "team", "companies", "corporation", "inc",
            "rights", "reserved", "copyright", "apply", "applied",
            "candidate", "candidates", "applicants", "applicant",
            "consideration", "qualified", "applying", "hire", "hired",
            "working", "career", "benefits", "vacation",
            "medical", "dental", "vision", "insurance", "life",
            "providing", "offer", "offers", "offered", "package",
            "competitive", "compensation", "salary", "pay", "bonus",
        }
        ...
        for part in parts:
            part = part.strip()
            if 2 <= len(part) <= 40 and part.lower() not in _SKILL_STOPS:
        ...
        for token in tokens:
            if len(token) >= 3 and token.lower() not in _SKILL_STOPS:
